...
from app.api.v1.endpoints import health, usuarios, comercios, auth, tax_data, content, feed, admin, user_upgrade
...
api_router.include_router(user_upgrade.router, prefix="/user-upgrade", tags=["user-upgrade"])
